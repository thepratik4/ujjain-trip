        ...
        <div className="p-4 sm:p-5 pb-3 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">Record a payment from fund or out-of-pocket</p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-3.5 overscroll-contain">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Mahakal Lok Passes / Auto / Dinner"
            ...
            <div>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 gap-1.5 max-h-32 overflow-y-auto p-1 bg-slate-50 rounded-2xl border border-slate-200">
                {CATEGORIES.map((cat) => (
                  <button
                    type="button"
                    key={cat.label}
                    onClick={() => setCategory(cat.label)}
                    className={`p-1.5 rounded-xl text-[11px] font-bold flex items-center gap-1 transition-all border cursor-pointer ${
                      category === cat.label
              ...
              {billImage ? (
                <div className="flex items-center gap-3 p-2.5 rounded-2xl bg-slate-50 border border-slate-200">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="text-[10px] text-slate-400">Photo saved with record</span>
                  </div>
                  <button
                    type="button"
                ...
                <label className="flex items-center justify-center gap-2 p-2.5 rounded-2xl border-2 border-dashed border-slate-300 bg-slate-50 hover:bg-slate-100 transition-all cursor-pointer text-xs font-bold text-slate-600">
                  {isUploading ? (
                    <>
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Petrol for Ertiga car"
